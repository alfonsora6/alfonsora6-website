...
Durante mi formación, he adquirido un amplio conocimiento en la gestión de sistemas, servidores, redes y en la resolución de incidencias técnicas, siempre buscando la mejora continua en cada proyecto. Mi enfoque siempre ha sido encontrar soluciones efectivas, adaptarme rápidamente a nuevas tecnologías y asegurar el máximo rendimiento en cada entorno IT.

Áreas de Especialización:

- Administración de Sistemas: Gestión de servidores, redes y sistemas operativos.
- Automatización y Gestión de Configuración: Herramientas como Ansible, Vagrant, Terraform.
- Infraestructura en la Nube (Cloud): Azure.
- Sistemas Linux/Windows: Instalación, configuración y mantenimiento.
- Seguridad y Backup: Implementación de protocolos de seguridad y sistemas de respaldo.

Lo que me define:

- Resolución rápida y eficaz de problemas técnicos.
- Capacidad de trabajar en equipo y liderazgo colaborativo.
- Enfoque en la automatización para mejorar la eficiencia operativa.
- Comprometido con el aprendizaje continuo y la implementación de nuevas tecnologías.
- Disponibilidad inmediata para nuevos proyectos y desafíos.
...
Many of them were especially interested in frontend and wanted to better understand and master CSS. Therefore, I started creating small videos that I uploaded to mytely so they could consult them when needed.
